...
function buildPromptsUrl(locale: string, suffix = ''): string {
  const normalizedLocale = getLocalePrefix(locale) || 'en-US';
  const suffixQuery = suffix ? `&${suffix.replace(/^\?/, '')}` : '';
  return `https://www.atlascloud.ai/prompts-hub/gpt-image-2-prompt?locale=${encodeURIComponent(normalizedLocale)}${suffixQuery}`;
}
...
[![Update README](https://github.com/AtlasCloudAI/awesome-gpt-image-2-prompts/actions/workflows/update-readme.yml/badge.svg)](https://github.com/AtlasCloudAI/awesome-gpt-image-2-prompts/actions)
...
1. Click [**${t('submitNewPrompt', locale)}**](https://github.com/AtlasCloudAI/awesome-gpt-image-2-prompts/issues/new?template=submit-prompt.yml)
2. ${t('fillForm', locale)}
...
**[📝 ${t('submitPrompt', locale)}](https://github.com/AtlasCloudAI/awesome-gpt-image-2-prompts/issues/new?template=submit-prompt.yml)** •
**[⭐ ${t('starRepo', locale)}](https://github.com/AtlasCloudAI/awesome-gpt-image-2-prompts)**
